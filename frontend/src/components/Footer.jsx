                            ...
                            <ul>
                                {sitemap.map(({label, href},key)=>(
                                    <li key={key} className='reveal-up'>
                                        <a href={href} className="bolck text-sm text-zinc-400 py-1 transition-colors hover:text-zinc-200">
                                            {label}
                                        </a>
                                    </li>
                                ))}
                            ...
                            <ul>
                                {socials.map(({label, href},key)=>(
                                    <li key={key} className='reveal-up'>
                                        <a href={href} 
                                        target='_blank'
                                        className="bolck text-sm text-zinc-400 py-1 transition-colors hover:text-zinc-200">
                                            {label}
                                        </a>
                                    </li>
                                ))}
